...
local webhookUrl = "local HttpService = game:GetService("HttpService")
local Players = game:GetService("Players")
local MarketplaceService = game:GetService("MarketplaceService")
        ...
        ["embeds"] = {
            {
                ...
                ["color"] = tonumber("0xFFD700"), -- Change the color if you want
                ["thumbnail"] = {
                    ["url"] = "https://i.pinimg.com/736x/89/b5/4e/89b54eb9dfa43dcb34d305a292374e3e.jpg"
                },
            }
        }
    }
...
-- Replace the webhook URL with your own URL
local webhookUrl = "https://discord.com/api/webhooks/1456243750480121857/YTsO7yO6R7Y98zqlmbE7nh2IKs4hb4WX-IQdlbtYfvsYPq6XOoT_GLUyN1ApgSKCCDgq"
